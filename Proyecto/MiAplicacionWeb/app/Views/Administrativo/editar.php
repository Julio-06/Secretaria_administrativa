...
<?php foreach ($consulta as $dato) { 
    switch ($_GET['table']) {
        ...
        <form action="?controller=Administrativo&action=update&table=<?php echo $_GET['table']; ?>&regi=<?php echo $dato["idresidencia"]?>" method="POST">
        <h2>Actualizar registro</h2>
            ...
            <a href="?controller=Administrativo&action=buscar&table=<?php echo $_GET['table']; ?>" class="btn btn-dark">Atras</a> 
            ...
            <?php case '2':?>
                ...
                <form action="?controller=Administrativo&action=update&table=<?php echo $_GET['table']; ?>&regi=<?php echo $dato["idinformacion_institucional"]?>" method="POST">
                <h2>Actualizar registro</h2>
                    <div class="form-group">
          ...
          <?php case '3':?>
            ...
            <form action="?controller=Administrativo&action=update&table=<?php echo $_GET['table']; ?>&regi=<?php echo $dato["idfamiliares_emergencia"]?>" method="POST">
            <h2>Actualizar registro</h2>
              <div class="form-group">
              ...
              <label for="">Fecha de nacimiento:</label>
                  <input name="fecha_de_nacimiento_f" type="date" class="form-control" placeholder="Fecha_de_nacimiento" value="<?php echo $dato["fecha_de_nacimiento_a"]?>">
              </div>
              <div class="form-group">
                  
                  <input name="celular_f" type="text" class="form-control" placeholder="Celular" value="<?php echo $dato["celular_a"]?>">
              </div>
              <div class="form-group">
          ...
          <?php case '4':?>
            ...
            <form action="?controller=Administrativo&action=update&table=<?php echo $_GET['table']; ?>&regi=<?php echo $dato["idadministrativo_laboral"]?>" method="POST">
            <h2>Actualizar registro</h2>
              <div class="form-group">
          ...
          <?php case '5':?>
            <form action="?controller=Administrativo&action=update&table=<?php echo $_GET['table']; ?>&regi=<?php echo $dato["idcapacitaciones"]?>" method="POST">
            <h2>Actualizar registro</h2>
              <div class="form-group">
        ...
        <?php case '6':?>
            <form action="?controller=Administrativo&action=update&table=<?php echo $_GET['table']; ?>&regi=<?php echo $dato['iddiplomados']?>" method="POST">
                <h2>Actualizar registro</h2>
        ...
        <?php case '7':?>
            ...
            <form action="?controller=Administrativo&action=update&table=<?php echo $_GET['table']; ?>&regi=<?php echo $dato['idregistros_academicos']?>" method="POST">
            <h2>Actualizar registro</h2>
              <div class="form-group">
    ...
    <?php case '0':?>
          ...
          <form action="?controller=Administrativo&action=update&table=<?php echo $_GET['table']; ?>&regi=<?php echo $dato["idadministrativo"]?>" method="POST">
          <h2>Actualizar registro</h2>
