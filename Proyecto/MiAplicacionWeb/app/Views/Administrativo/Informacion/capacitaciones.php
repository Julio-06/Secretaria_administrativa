      ...
      <tbody>
          ...
          foreach ($datos as $dato) { ?>
                  <tr>
                      ...
                      <td>
                      <a href="?controller=Administrativo&action=editar&table=<?php echo $_GET['table']; ?>&no=<?php echo $dato['idcapacitaciones']?>" class="btn btn-danger" >
                      Editar
                      </a>
                      <a href="?controller=Administrativo&action=confirmacion&table=<?php echo $_GET['table']; ?>&no=<?php echo $dato['idcapacitaciones']?>" class="btn btn-danger" >
                        Eliminar
                      </a>
                      </td>      
                </tr>
