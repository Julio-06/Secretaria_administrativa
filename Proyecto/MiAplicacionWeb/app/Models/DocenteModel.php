...
class DocenteModel{
    ...
    public function insert($titulo,$año,$instituto,$tabla,$usuario){
        $registro = $this->db->query("insert into $tabla values ($titulo,$año,$instituto,$usuario);");
        while($filas = $registro->fetch_assoc()){
            $this->docentes[] = $filas;
        }
        return $this->docentes;
